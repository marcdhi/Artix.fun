...
export interface ArtifactNFT extends BaseContract {
  ...
  mintMemeNFT: TypedContractMethod<
    [creator: AddressLike, tokenURI: string, network: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "NFTMinted(uint256,address,string,uint8)": TypedContractEvent<
      NFTMintedEvent.InputTuple,
      NFTMintedEvent.OutputTuple,
      NFTMintedEvent.OutputObject
    >;
